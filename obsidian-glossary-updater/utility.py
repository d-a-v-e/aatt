...
def format_glossary_prompt(extracted_terms, glossary_content, vault_purpose):
    ...
    prompt = (
        ...
        "5. Do not include a header at the top of the file (do not add '# Glossary' or similar).\n"
        "6. Do not modify other sections of the Glossary.md file unless you are adding a definition under an existing entry.\n"
        "7. If no updates are necessary, respond with 'false'.\n"
        "8. Provide only the updated Glossary.md content in plain text format, without wrapping it in code blocks or adding any additional explanations.\n"
        "\n"
